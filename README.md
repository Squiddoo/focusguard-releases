...
[**FocusGuard-Setup-1.0.16.exe**](https://github.com/Squiddoo/FocusGuard/releases/download/v1.0.16/FocusGuard-Setup-1.0.16.exe)
...
See all versions: [Releases](https://github.com/Squiddoo/FocusGuard/releases)
